 ...
 *
 * @type {{[k in 'open'|'close'|'quit'|'minimize'|'maximize'|'fullscreen'|'focus']: (app: string, ...args: any[]) => Promise<string>}}
 */
export const actions = {
    ...
    quit: (app) => callOSA(`launchpad_shortcut_deck_quit([[${resolveTarget(app)}]])`),
